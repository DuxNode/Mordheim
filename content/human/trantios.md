...
*Background for Trantios — to be written.*
...
<!-- _review (not shown on site):
  ...
  - Trantio special rules (player-enforced; QM cannot represent): best-equipped human warband in Lustria - start a one-off match with +100 GC; in a Lustrian campaign start with +20% GC added to total.
  - Skill tables encoded per the mordheimer.net Tilean table (Jun 2026): Captain C/Sh/Ac/St/Sp; Champion C/Sh/Sp; Youngblood C/Sh/St.
