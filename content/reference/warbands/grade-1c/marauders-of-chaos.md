...
**Spawn of Chaos:** If you lost the preceding battle, add +1 to the roll for each of your Heroes that was taken out of action during the battle. On a total of 12 or more the warband's leader turns into a Spawn of Chaos. His experience, skills, injuries and equipment are lost.

**Mark of Chaos:** If you won the battle, add +1 for every enemy model the leader took out of action. On a total of 12 or more you may choose a Mark of Chaos for the winning leader (see Mark of the Dark Gods below).
...
When starting a Marauders of Chaos warband you may decide which of the following three major Chaos tribes your warriors belong to. All warbands follow the same rules for Choice of Warriors, Skills and Equipment. Any exceptions are described below.
...
**Reavers:** Due to their proximity to the Empire and the frequency of their raiding, the Norse excel at finding the best equipment and supplies quickly. As such, they gain +1 to their rarity rolls when searching during the post-game sequence.
...
**Bone Bows:** The Kurgans are renowned for making bows using the bones of their fallen enemies. Heroes and Chaos Marauder Henchmen may use bows (cost: 10 gold crowns, availability: common).

**Difficult Customers:** The Kurgan live far away from civilisation and are certainly not welcomed when they raid southern farmsteads and villages. A Kurgan warband suffers –1 when rolling to find Rare items, except for Great Axes and Barbed Whips.
...
**Disloyalty:** The treachery of the Hung is infamous. The maximum number of warriors in the warband is 12 instead of 15.
...
Marauders of Chaos use the maximum profile for Marauder of Chaos. Marauders with the Chosen of Chaos skill use the maximum profile for Warriors of Chaos.
...
<tbody><tr><td class="profile-cell"></td><td>4</td><td>5</td><td>3</td><td>4</td><td>4</td><td>1</td><td>5</td><td>1</td><td>8</td></tr></tbody>
</table>
...
**Leader:** Any warrior within 6" of the Marauder Chieftain may use his Leadership instead of his own when taking Leadership tests.
...
<table class="statblock">
<thead><tr><th class="profile">Profile</th><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td class="profile-cell"></td><td>4</td><td>4</td><td>3</td><td>3</td><td>3</td><td>1</td><td>4</td><td>1</td><td>8</td></tr></tbody>
</table>
...
**Wizard:** A Seer is a Wizard and may use Magic as detailed in the Magic section.

**Mark of Chaos:** The Seer receives a Mark of Chaos when hired, chosen to correspond with the tribe's patron. The Mark determines which spell list the Seer uses: a Seer with the Mark of Tchar uses Tchar Rituals; a Seer with the Mark of Onogal uses Onogal Rituals; a Seer with the Mark of Shornaal uses Shornaal Rituals; a Seer with the Mark of Chaos Undivided uses Chaos Rituals. A Seer with the Mark of Arkhar becomes a Bloodfather — a war-priest who cannot cast spells (see Mark of the Dark Gods below). A Seer who becomes warband leader must choose the Mark for his patron when first rewarded through the Eye of the Gods rule.
...
<table class="statblock">
<thead><tr><th class="profile">Profile</th><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td class="profile-cell"></td><td>4</td><td>4</td><td>3</td><td>4</td><td>3</td><td>1</td><td>4</td><td>1</td><td>7</td></tr></tbody>
</table>
...
<table class="statblock">
<thead><tr><th class="profile">Profile</th><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td class="profile-cell"></td><td>4</td><td>D6</td><td>3</td><td>D6</td><td>D6</td><td>1</td><td>4</td><td>D3</td><td>7</td></tr></tbody>
</table>
...
**Weapons/Armour:** The Condemned uses no equipment but fights without penalties.
...
**Fear:** The Condemned's unnatural appearance causes fear in his enemies.

**Experience:** Whenever the Condemned would increase one of his variable attributes the player rolls the appropriate die instead. If the player is satisfied with the result, he may set the attribute at that number. Otherwise the attribute remains variable and the advance is lost. The maximum attributes of the Marauders may be exceeded due to the special nature of the Condemned.

**Fate:** Once all variable attributes are set, the Condemned may use weapons, armour and miscellaneous equipment as usual. However, if he has 90 Experience and still has variable attributes, his patron could not save him from his former god's wrath and his soul and body are lost — he turns into a Spawn of Chaos. If the warband already contains a Spawn of Chaos, the doomed warrior wanders off into the wastes, never to be seen again.
...
<table class="statblock">
<thead><tr><th class="profile">Profile</th><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td class="profile-cell"></td><td>4</td><td>4</td><td>3</td><td>3</td><td>3</td><td>1</td><td>4</td><td>1</td><td>7</td></tr></tbody>
</table>
...
<table class="statblock">
<thead><tr><th class="profile">Profile</th><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td class="profile-cell"></td><td>7</td><td>4</td><td>0</td><td>4</td><td>3</td><td>1</td><td>3</td><td>1</td><td>5</td></tr></tbody>
</table>
...
**Animals:** Warhounds of Chaos are animals and thus do not gain experience.
...
<table class="statblock">
<thead><tr><th class="profile">Profile</th><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td class="profile-cell"></td><td>2D6</td><td>3</td><td>0</td><td>4</td><td>5</td><td>3</td><td>2</td><td>D6+1</td><td>10</td></tr></tbody>
</table>
...
**Large:** Spawns of Chaos are huge creatures and count as Large Targets as defined in the shooting rules.
...
**Chosen of Chaos:** The Hero has been found worthy of his god's service and entered the rank of a Chaos Warrior. He uses the maximum profile for Warriors of Chaos and the Hero Equipment list (if he does not already).

**Tattooed Body:** Only the warband's leader may have this skill. The Hero's body is covered with unholy Chaos signs to attract his patron's attention. The Eye of the Gods special rule's effect (of becoming a Chaos Spawn or receiving a Mark) happens on a result of 10+ instead of 12+. Note that for the less favoured Norse leaders this is 11+.

**Sweeping Blow:** Whenever the Hero takes an enemy model out of action using a double-handed weapon he may immediately make an additional attack against another model in base contact. Requires the Strongman skill.

**Mutant:** The Hero may buy one mutation. See the Mutations section of the Cult of the Possessed warband. Heroes with the Mark of Onogal may choose a Blessing of Nurgle instead, except the Mark of Nurgle. Note that unlike other skills, Marauder Heroes may take this skill more than once.

**Heart of the Warrior:** Only the warband's leader may have this skill. He may re-roll any failed Rout test and is immune to fear and All Alone tests.
...
### Barbed Whip
**Cost:** 15 gc · **Availability:** Rare 9

*Originally used for taming the wild Chaos Hounds, the barbed whip has proven effective in combat also.*

**Range:** Close Combat · **Strength:** As user

**Special Rules**

**Whipcrack:** When the wielder charges they gain +1 Attack for that turn (added after any other modifications). When the wielder is charged they gain +1 Attack that may only be used against the charger; this additional attack strikes first. If simultaneously charged by two or more opponents the wielder still only receives +1 Attack in total. If using two whips the wielder gets +1 Attack for the additional hand weapon, but only the first whip benefits from Whipcrack.
...
### Great Axe
**Cost:** 25 gc · **Availability:** Rare 8 (Marauders of Chaos Heroes with the Chosen of Chaos skill only)
...
**Two-handed:** A model using a great axe may not use a shield, buckler or additional weapon in close combat. If the model has a shield he still gets +1 to his armour save against shooting.
...
**Cutting Edge:** A Great Axe has an extra save modifier of –1 in addition to the standard Strength modifier.

### Obsidian Weapon
**Cost:** 4× base price · **Availability:** Rare 12

*Obsidian is mined in the Dark Lands by the minions of Chaos. When expertly derived from its ore, the curious volcanic rock becomes ensorcelled. Forging weapons using these vile techniques requires acute diabolic expertise, making them extremely rare.*

**Range:** Close Combat · **Strength:** As user +1

**Special Rules**

**Blemished:** Although not strictly tainted by Chaos, all Obsidian artefacts are considered tinged with evil by the darkness associated with their artisans. Obsidian weapons may never be used by Dwarfs, Elves, Sisters of Sigmar, Witch Hunters or Priests.
...
*Chaos Armour is a suit of strangely-worked and unnatural metal. It is the mark of a Dark God's favour.*
...
**Gift of Chaos:** Chaos Armour is a gift from the Dark Gods to the worthy warrior. A Hero who successfully purchases a suit of Chaos Armour will never give it to another warband member but puts it on himself immediately. Chaos Armour becomes fused to the body of its wearer and can never be removed.
...
### Wolfcloak
**Cost:** 10 gc · **Availability:** Common (Middenheimers only)

*In Middenheim it is still considered to be the feat of a true man to slay a great wolf single-handed. Warriors who accomplish such a deed will command the respect of their peers, and their cloaks will be blessed by the High Priest of the Cult of Ulric.*

**Special Rules**

To acquire a Wolfcloak, a Hero must pay 10 gc and roll equal to or under his Strength on a D6. If successful, the Hero finds and slays the wolf and can wear its cloak as a mark of his skill and prowess. Note that Middenheimers may buy Wolfcloaks when starting their warband without making an availability roll. A model wearing a Wolfcloak gains +1 to his armour saves against all shooting attacks.

---

## Mark of the Dark Gods

The Eye of the Gods special rule may let the warband's leader choose a Mark of the Dark Gods. With the exception of the Mark of Chaos Undivided there may never be two models in the warband with different Marks. Upon being hired, Seers choose their Mark in correspondence with the tribe, granting an audience with their god. A Seer who becomes leader at the same time must choose the Mark for his associated patron when being rewarded through the Eye of the Gods.

### Mark of Chaos Undivided

*A Hero with this mark believes in Chaos in its purest form instead of the division into four Chaos Gods.*

**Leader:** All warband members within the leader rule's radius (6" normally, 12" with Battle Tongue) may re-roll all failed Leadership tests.

**Seer:** With the Seer of Chaos Undivided as the tribe's spiritual leader, the warband may include 0–3 Gors (see Beastmen Raiders) that count towards the maximum of 15 members. Re-roll all results of 'The lad's got talent' for them. A Seer of Chaos Undivided uses Chaos Rituals.
...
**Leader:** The Hero is capable of casting spells and immediately learns one random spell from the Tchar Rituals. However, he suffers –1 on all rolls for Casting Difficulty unless he was a wizard before.

**Seer:** A Seer of Tchar has command of powerful sorcery. The Seer starts with two spells from the Tchar Rituals — one may be chosen freely, the second is randomly determined.
...
**Seer:** A Seer with the Mark of Arkhar counts as a Bloodfather — a war-priest who cannot cast spells. Instead he communes with daemons and his deity through visions. Take a Leadership test each time a Bloodfather takes an enemy out of action in hand-to-hand combat. If the test is passed, add +1 to the Weapon Skill, Strength, Toughness or Initiative of the war-priest until the end of the battle. Each characteristic can be increased only once in this way. A Bloodfather may take Strength skills in addition to those normally available to a Seer.
...
**Leader:** The Hero gets +1 Toughness and may re-roll on the Serious Injuries table once. In addition, he is immune to poison.

**Seer:** The Seer uses Onogal Rituals. A Seer of Onogal is immune to poison.
...
**Leader:** Enemy models that are not immune to psychology cannot attack the Hero in close combat unless they pass a Leadership test with 3D6, discarding the lowest D6 result. If the roll is failed, these models are hit automatically in close combat. Once they pass, they do not have to test again for the duration of the battle. Note that the Lizardman's Cold Blooded special rule cannot be applied to this effect.

**Seer:** A Seer of Shornaal uses the Shornaal Rituals. If the Seer was not taken out of action during the battle, instead of searching for rare items he may brew a strong drink for the warband (treat as Bugman's Ale). Note that this item cannot be sold.
