...
**Reavers:** Due to their proximity to the Empire and the frequency of their raiding, the Norse excel at finding the best equipment and supplies quickly. They gain a +1 to their rarity rolls when searching during the post-game sequence.
...
**Difficult Customers:** While some of the less bloodthirsty Norse and Hung tribes even trade with merchants from the south, the Kurgan live far from civilisation and are certainly not welcomed when they raid southern farmsteads and villages. Therefore a Kurgan warband suffers –1 when rolling to find Rare items, except for Great Axes and Barbed Whips.
...
### Marauder Chieftain
<span class="unit-meta">Hero · Leader · 0–1 · 95 gc · Starting XP: 20</span>

<table class="statblock">
<thead><tr><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td>4</td><td>5</td><td>3</td><td>4</td><td>4</td><td>1</td><td>5</td><td>1</td><td>8</td></tr></tbody>
</table>
...
### Seer
<span class="unit-meta">Hero · 0–1 · 45 gc · Starting XP: 8</span>

<table class="statblock">
<thead><tr><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td>4</td><td>4</td><td>3</td><td>3</td><td>3</td><td>1</td><td>4</td><td>1</td><td>8</td></tr></tbody>
</table>
...
**Mark of Chaos:** The Seer gets a Mark of Chaos when hired to determine the kind of magic he uses. He can have the Mark of the Serpent, the Mark of the Crow, the Mark of the Eagle, the Mark of Arkhar or the Mark of Chaos Undivided. The Mark determines the spell list available to the Seer — see Marks of the Dark Gods below. The Seer's Mark is player-chosen at recruitment; note which Mark your Seer carries on the warband roster, as it determines his spell list for the entire campaign.

---

### Champions
<span class="unit-meta">Hero · 0–2 · 45 gc · Starting XP: 8</span>
...
### Condemned
<span class="unit-meta">Hero · 0–1 · 55 gc · Starting XP: 8</span>

<table class="statblock">
<thead><tr><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td>4</td><td>D6</td><td>3</td><td>D6</td><td>D6</td><td>1</td><td>4</td><td>D3</td><td>7</td></tr></tbody>
</table>
...
### Chaos Marauders
<span class="unit-meta">Henchman · any number · 35 gc</span>
...
### Warhounds of Chaos
<span class="unit-meta">Henchman · 0–5 · 15 gc</span>

<table class="statblock">
<thead><tr><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td>7</td><td>4</td><td>0</td><td>4</td><td>3</td><td>1</td><td>3</td><td>1</td><td>5</td></tr></tbody>
</table>
...
### Spawn of Chaos
<span class="unit-meta">Henchman · 0–1 · 180 gc</span>

<table class="statblock">
<thead><tr><th>M</th><th>WS</th><th>BS</th><th>S</th><th>T</th><th>W</th><th>I</th><th>A</th><th>Ld</th></tr></thead>
<tbody><tr><td>2D6</td><td>3</td><td>0</td><td>4</td><td>5</td><td>3</td><td>2</td><td>D6+1</td><td>10</td></tr></tbody>
</table>
...
*Heroes have no access to missile weapons.*
...
**Mutant:** The Hero may buy one mutation (see the Mutations section of the Cult of the Possessed for special rules). Heroes with the Mark of Onogal may choose a Blessing of Nurgle instead, except the Mark of Nurgle blessing. Note that unlike other skills Marauder Heroes may take this skill more than once.
...
**Cutting Edge:** A Great Axe has an extra save modifier of –1, so a model with Strength 4 using a Great Axe has a –4 save modifier in hand-to-hand combat.
...
The Eye of the Gods special rule may let the warband's leader choose a Mark of the Dark Gods. With the exception of the Mark of Chaos Undivided there may never be two models in the warband with different Marks. Upon being hired, Seers choose their Mark in correspondence with the tribe, granting an audience with their god.

The Mark carried by the Seer determines which spell list he uses, as noted below. Players should record the Seer's Mark on the warband roster at recruitment. Marks are player-chosen and treated as player-enforced throughout the campaign — the Seer's spell list does not change once set.

### Mark of Chaos Undivided

*A Hero with this mark believes in Chaos in its purest form instead of the division into four Chaos Gods.*

**Leader:** All warband members within the leader rule's radius (6", or 12" with Battle Tongue) may re-roll all failed Leadership tests.
...
**Seer:** A Seer of Tchar starts with two spells from the **Tchar Rituals** — one chosen freely, the second determined randomly.
...
Used by Seers with the Mark of Chaos Undivided. The Seer starts with one spell determined randomly. In addition, the Seer may learn a new spell instead of a new skill.
...
**Vision of Torment — Difficulty 10:** *The Chaos Mage summons horrible visions of the realm of Chaos, causing his enemy to recoil in utter horror.* This spell has a range of 6" and must be cast on the closest enemy model. If the Chaos Mage is in hand-to-hand combat, he must choose his target from those in base contact with him. The affected model is immediately stunned. If the model cannot be stunned it is knocked down instead.

**Eye of God — Difficulty 7:** *The Chaos Mage implores the Dark gods to grant a boon to their servant.* You may use the Eye of God successfully only once per battle. Choose any single model within 6", friend or foe. Roll a D6: on a 1 the wrath of the gods descends upon the target and the model is taken out of action immediately (though does not roll on the Serious Injury chart after the battle); on a 2–5 the model gains +1 to any one characteristic during this battle; on a 6 the model gains +1 to all of its characteristics for the duration of the battle.

**Dark Blood — Difficulty 8:** *The Chaos Mage cuts his palm and his blood spurts out, burning flesh and armour.* This attack has a range of 8" and causes D3 Strength 5 hits, striking the first model in its path. After using this spell the Chaos Mage must roll on the Injury table for himself to see how dangerous the wound is, though treat the out of action result as stunned instead.

**Lure of Chaos — Difficulty 9:** *The Chaos Mage calls upon the taint of chaos which exists in the inner soul of all living beings.* The spell has a range of 12" and must be cast on the closest enemy model. Roll a D6 and add the Chaos Mage's Leadership to the score. Then roll a D6 and add the target's Leadership to the score. If the Chaos Mage beats his opponent's score he gains control of the model until the model passes a Leadership test in his own recovery phase. The model may not commit suicide, but can attack models on his own side, and will not fight warriors from the Chaos Mage's warband.

**Wings of Darkness — Difficulty 7:** *The Chaos Mage is lifted from the ground by two shadowy Daemons and carried wherever he wants to go.* The Chaos Mage may immediately move anywhere within 12", including into base contact with an enemy, in which case he counts as charging. If he engages a fleeing enemy, in the close combat phase he will score one automatic hit and then his opponent will flee again (if he survives).

**Word of Pain — Difficulty 7:** *Speaking the forbidden name of his dark god, the Chaos Mage causes indescribable pain to all who hear it.* All models within 3" of the Chaos Mage, friend or foe, suffer one Strength 3 hit. No armour saves are allowed.
